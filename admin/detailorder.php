...
// Ambil invoice dari parameter URL
$invoices = $_GET['inv'];
...
if (!$t_order) {
    echo "<div class='container'><h3>Pesanan tidak ditemukan atau sudah ditolak.</h3></div>";
    include 'footer.php';
    exit; // Hentikan eksekusi jika pesanan tidak ditemukan
}
...
// Inisialisasi array untuk menyimpan nama material
$nama_material = [];
...
<div class="container">
    ...
    <button type="hidden" data-toggle="modal" data-target="#myModal" id="btn"
        style="background-color: #fff; border: #fff;"></button>
